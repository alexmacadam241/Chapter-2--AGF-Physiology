---
title: "A. kenti Adult bleaching statistics- bayes"
author: "Alex Macadam"
date: "2023-11-23"
...
Read in data
```{r}
colour <- read.csv('/Users/alexmacadam/Documents/GitHub/Chapter-2--AGF-Physiology/data/Adult-bleaching.csv', header=T) |>
...
ce_T1_ten<- T1.brm2 %>%
    ...
    plot(points = TRUE)
ce_T1_ten
ce_T1_ten<- ce_T1_ten$`Population:Temperature`$data |>
  mutate(Species = "A. kenti", Timepoint = "1")
```
...
ce_T3_ten<- T3.brm2 %>%
    ...
    plot(points = TRUE)
ce_T3_ten
ce_T3_ten<- ce_T3_ten$`Population:Temperature`$data |>
  mutate(Species = "A. kenti", Timepoint = "3")
```
