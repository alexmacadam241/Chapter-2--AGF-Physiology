...
```{r}
#load data
survival_hot <- read.csv("/Users/alexmacadam/Documents/GitHub/Chapter-2--AGF-Physiology/data/Larvae-survival-2021.csv", header=T, fileEncoding="UTF-8-BOM") |>
...
#saveRDS(survival.brm, file = "survival.brm4_A.hyacinthus.rds")
survival.brm <- readRDS("/Users/alexmacadam/Documents/GitHub/Chapter-2--AGF-Physiology/data/survival.brm4_A.hyacinthus.rds")
```
